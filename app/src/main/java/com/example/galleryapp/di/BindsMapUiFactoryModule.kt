...
abstract class BindsMapUiFactoryModule {
    ...
    @Binds
    abstract fun bindAuthToMapUiFactory(authExceptionToUiExceptionFactory: AuthExceptionMapUiFactory): HandleFactory<Exception>

    @Binds
    abstract fun bindPhotosToMapUiFactory(failMapUiFactory: PhotosFailMapUiFactory): HandleFactory<PhotosServerFail>
}